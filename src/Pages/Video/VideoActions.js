        ...
        <div>
            <Layout >
                ...
                <div className="container">
                    <SingleVideo class="m20" />
                    <div className="down">
                        <div className="buttons d-flex mt-3">
                            <button className='btnNoBg2' data-bs-toggle="modal" data-bs-target="#userTableModal" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
